...
import com.danielbytes.rps.services.auth.{ AnonymousTokenRequest, GoogleTokenRequest }
import de.heikoseeberger.akkahttpcirce.FailFastCirceSupport._
import io.circe.generic.auto._

import scala.concurrent.{ ExecutionContext, Future }

trait SessionRoutes extends ApplicationSessionDirectives with Encoders {
